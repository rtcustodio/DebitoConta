...
begin
  ...
  F02 := FConteudoLinha.Substring(1, 1); //código de remessa
  F03 := FConteudoLinha.Substring(2, 20); //código do convênio
  F04 := FConteudoLinha.Substring(22, 20); //nome da empresa
  F05 := FConteudoLinha.Substring(42, 3); //código do banco
  F06 := FConteudoLinha.Substring(45, 20); //nome do banco
  F07 := FConteudoLinha.Substring(65, 8); //data de geração
  F08 := FConteudoLinha.Substring(73, 6); //numero sequencial do arquivo
  F09 := FConteudoLinha.Substring(79, 1); //versão do layout
  F10 := FConteudoLinha.Substring(81, 17); //identificação do serviço
